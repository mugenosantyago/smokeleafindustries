...
// DataGenerators temporarily disabled - GatherDataEvent is abstract in 1.21.8
// TODO: Re-enable data generation using GatherDataEvent.Server subclass when data providers are fixed
// @EventBusSubscriber(modid = SmokeleafIndustries.MODID)
public class DataGenerators {

    // GatherDataEvent is abstract in 1.21.8 - must use GatherDataEvent.Server or GatherDataEvent.Client
    // All data generation code is currently commented out, so this handler is disabled
    // @SubscribeEvent
